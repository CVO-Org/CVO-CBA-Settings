...
force force OCAP_settings_minMissionTime = 15;
force force OCAP_settings_minPlayerCount = 4;
...
force force ace_medical_deathChance = 0.3;
force force ace_medical_dropWeaponUnconsciousChance = 0.05;
...
force force ace_medical_treatment_allowSelfIV = 2;
force force ace_medical_treatment_allowSelfPAK = 2;
force force ace_medical_treatment_allowSelfStitch = 2;
force force ace_medical_treatment_allowSharedEquipment = 0;
force force ace_medical_treatment_bandageEffectiveness = 1.2;
...
force force ace_medical_treatment_cprSuccessChanceMax = 0.85;
...
force force ace_medical_treatment_litterCleanupDelay = 1800;
...
force force ace_medical_treatment_maxLitterObjects = 2000;
